...
public class SeekBarQuantityListener implements OnSeekBarChangeListener {
	...
	public SeekBarQuantityListener(Context con, TextView label, int[] colors) {
		this.context = con;
		this.mLabel = label;

		// Get text for labels from strings.xml
		this.labels = new String[] {
				context.getString(R.string.seekbarQuan0),
				context.getString(R.string.seekbarQuan1),
				context.getString(R.string.seekbarQuan2),
				context.getString(R.string.seekbarQuan3),
				context.getString(R.string.seekbarQuan4) };
